...
contract SolnSquareVerifier is ERC721Mintable{
    ...
    function mintNewToken(address solver, uint index, uint[2] memory a, uint[2] memory a_p,
...
// I got this comment above from student knowldge and I hope I understood it and implement it right :)
        ...
        bool isVerified = verifierContract.verifyTx(a, a_p,b, b_p, c, c_p, h, k, input);
        require(isVerified," The prove you gave is wrong.");
