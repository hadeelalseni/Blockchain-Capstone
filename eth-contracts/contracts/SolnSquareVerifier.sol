...
contract SolnSquareVerifier is ERC721Mintable{
    ...
    function mintNewToken(address solver, uint256 index, uint[2] memory a, uint[2] memory a_p, uint[2][2] memory b, uint[2] memory b_p, uint[2] memory c, uint[2] memory c_p, uint[2] memory h, uint[2] memory k, uint[2] memory input) public returns(bool){
...
// I got this comment above from student knowldge and I hope I understood it and implement it right :)
        ...
        require(verifier.verifyTx(a, a_p,b, b_p, c, c_p, h, k, input)," The prove you gave is wrong.");
