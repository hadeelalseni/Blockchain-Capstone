...
contract Pausable is Ownable{ // ALL DONE :)
...
contract ERC165 { // NO TODO HERE ^_^
...
contract ERC721 is Pausable, ERC165 { // ALL DONE :)
  ...
  // @dev Approves another address to transfer the given token ID
    ...
    /*function _mint(address to, uint256 tokenId) internal {
        ...
        // DONE :)
        require(!_exists(tokenId), "The token itself already exists.");
...
*/
    ...
    /*function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // DONE :)
        require(ownerOf(tokenId) == from, "the address from is not the owner.");

        // TODO: require token is being transfered to valid address
        // DONE :)
        require(to != address(0), "to address is zero!");
       // require(_isApprovedOrOwner(to, tokenId), "given address is invalid");
...
contract ERC721Enumerable is ERC165, ERC721 { // NO TODO HERE ^_^
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize { // ALL DONE :)
...
/*    function getSymbol() external view returns(string memory){
    ...
    function setTokenURI(uint256 tokenId, string memory baseTokenURI)internal{
        ...
        string memory uri = strConcat(baseTokenURI , tokenIdString);//baseTokenURI + tokenIdString;
